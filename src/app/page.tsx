...
function Navbar({ className }: { className?: string }) {
  ...
  return (
    <div
      className={cn("fixed top-10 inset-x-0 max-w-2xl mx-auto z-50 nav", className)}
    >
    ...
    <div className="box">
      ...
      <div className=" ">
        ...
        <div className="private-key container">
          <div
              class="gradient relative shadow-xl overflow-hidden hover:shadow-2xl group rounded-xl p-5 transition-all duration-500 transform">
              ...
              />
                <div class="">
                  ...
                  <p class="text-gray-400">General</p>
                  <a
          ...
          <div class="container w-full flex-1 p-8 order-1 shadow-xl rounded-3xl bg-gray-900 text-gray-400 sm:w-96 lg:w-full lg:order-2 lg:mt-0">
      <div class="mb-8 pb-8 flex items-center border-b border-gray-600">
        ...
        <div class="ml-5">
          <span class="block text-2xl font-semibold text-white">Personal details</span>
      ...
      <ul class="mb-10 font-medium text-xl">
        <li class="flex mb-6">
          ...
          <span class="ml-3">First name: <span class="text-white">Mary</span></span>
        </li>
        <li class="flex mb-6">
          <img src="https://res.cloudinary.com/williamsondesign/check-white.svg" />
          <span class="ml-3">Last name:  <span class="text-white">Phiri</span></span>
        </li>
        <li class="flex">
          <img src="https://res.cloudinary.com/williamsondesign/check-white.svg" />
          <span class="ml-3"><span class="text-white">Date of birth: </span> 24th Dec,1995</span>
        </li>
      </ul>
      <a href="#/" class="flex justify-center items-center bg-indigo-600 rounded-xl py-3 px-2 text-center text-white text-2xl">
        More Info
      ...
      <div className="left-pane">
          ...
          <BackgroundGradient className="rounded-[22px] max-w-sm p-4 sm:p-10 bg-black dark:bg-zinc-900">
            ...
            <h6 className="key">MIIEowIBAAKCAQEA1Q.. </h6>
            <br />
        ...
        The Railgun is an advanced electromagnetic projectile launcher capable of firing projectiles at velocities exceeding Mach 7
        </p>
